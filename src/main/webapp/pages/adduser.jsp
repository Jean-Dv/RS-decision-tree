        ...
        <div class="mx-auto max-w-screen-md px-4 py-16 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
            ...
            <div class="rounded-lg bg-white p-8 lg:col-span-3 lg:p-12">
              <form action="/rs_decision_tree/user" method="post" class="space-y-4">
                ...
                <div class="flex flex-row gap-x-4 justify-center">
                  <div class="w-1/4">
                    <select name="gender"
                      ...
                      <option value="JM">male</option>
                      <option value="SRV">female</option>
                  ...
                  <div class="w-1/4">
                    <select name="nationality"
                      ...
                      <option value="JM">Colombia</option>
                      <option value="SRV">EEUU</option>

                    </select>
                  </div>
                </div>
                <div class="mt-6 flex justify-center">
                  <button type="submit" class="inline-block w-1/2 rounded-lg bg-black px-5 py-3 font-medium text-white">
                    Envíar
                  </button>
                </div>
              </form>
