    ...
    <%@ include file="../components/navbar.jsp" %>
      ...
      <section class="bg-white">
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section class="relative flex h-32 items-center bg-while-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div class="max-w-xl lg:max-w-3xl">
              <div class="relative -mt-16 block lg:hidden">
                ...
                <p class="mt-4 leading-relaxed text-gray-500">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati nostrum corporis, aliquam
                  similique sequi eos voluptatem nisi deleniti sapiente. Deserunt facilis ipsa dignissimos, expedita
                  cumque earum in eius exercitationem quo!.
                </p>
              </div>
                ...
                <form action="/rs_decision_tree/hello" method="post">
                  <div class="flex flex-row gap-x-16 sm:flex-col sm:gap-y-4">
                    ...
                    <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                      <button type="submit" class=" inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm
                      font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none
